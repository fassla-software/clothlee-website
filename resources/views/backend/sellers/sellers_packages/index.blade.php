        ...
        <div class="col-lg-3 col-md-4 col-sm-12">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="h4">{{single_price($seller_package->commission)}}</p>
                    <p class="fs-15">{{translate('Interval') }}:
                        <span class="text-bold">{{$seller_package->interval}}</span>
                    </p>
                    <div class="mar-top">
                      
                            <a href="{{route('admin.seller_packages.edit', ['id'=>$seller_package->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" class="btn btn-sm btn-info">{{translate('Edit')}}</a>
