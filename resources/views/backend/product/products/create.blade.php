   ...
   {{ translate('SEO') }}
                ...
                <li class="nav-item">
                    <a class="nav-link" id="frequenty-bought-product-tab" href="#frequenty-bought-product"
                        data-toggle="tab" data-target="#frequenty-bought-product" type="button" role="tab" aria-controls="frequenty-bought-product" aria-selected="false" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row" style="display: none;">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="{{ translate('Product Name') }}" onchange="update_sku()" readonly required>
                                            </div>
                                        </div>
                                      <script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        var nameField = document.querySelector('input[name="name"]');
        if (nameField && !nameField.value) {
            nameField.value = generateRandomString(8); // Ensure a random value before submission
        }
    });
</script>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="hidden" class="form-control @error('unit') is-invalid @enderror" value="Pc" name="unit" >
                                            </div>
                                        </div>
   <div class="form-group row">
                    ...
                    <div class="tab-pane fade" id="price_and_stocks" role="tabpanel" aria-labelledby="price-and-stocks-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <br>
                                <!-- sku combination -->
                                <div class="sku_combination" id="sku_combination" style="display: none;">
