...
<form class="form-horizontal" action="{{ route('seller.custom_notification.send') }}" method="POST"
                   ...
                   <div class="form-group row">
    <label class="col-sm-3 control-label fw-700" for="title">{{ translate('Title') }}</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label class="col-sm-3 control-label fw-700" for="body">{{ translate('Body') }}</label>
    <div class="col-sm-9">
        <textarea class="form-control form-control-sm" name="body" rows="4" required
