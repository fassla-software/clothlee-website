...
<div class="d-block text-center my-3">
    @php
        $shopLogo = optional(Auth::user()->shop)->logo;
    @endphp
 @if (!empty($shopLogo))
        @if (is_numeric($shopLogo))
            <img src="{{ uploaded_asset($shopLogo) }}" style="width: 150px; height: auto;" class="mb-3 mx-auto d-block" alt="{{ get_setting('site_name') }}">
        @else
            <img src="{{ asset('public/uploads/all/'.$shopLogo) }}" style="width: 150px; height: auto;" class="mb-3 mx-auto d-block" alt="{{ get_setting('site_name') }}">
        @endif
    @else
        <img src="{{ uploaded_asset(get_setting('header_logo')) }}" style="width: 150px; height: auto;" class="mb-3 mx-auto d-block" alt="{{ get_setting('site_name') }}">
    @endif
    ...
    <p class="text-primary">{{ Auth::user()->email }}</p>
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
              ...
              <li class="aiz-side-nav-item">
    <a href="{{ route('seller.custom_notification') }}"
        class="aiz-side-nav-link {{ areActiveRoutes(['seller.custom_notification']) }}">
        ...
        <span class="aiz-side-nav-text">{{ translate('Send Notification') }}</span>
              ...
              <li class="aiz-side-nav-item">
    <a href="https://www.clothlee.com/seller/send-message-notification"
        class="aiz-side-nav-link">
    ...
    <a href="{{ route('sms_requests.index') }}" class="aiz-side-nav-link">
        ...
        <span class="aiz-side-nav-text">{{ translate('Send SMS Request') }}</span>
              ...
              <li class="aiz-side-nav-item">
    <a href="{{ route('seller.conversations.admin') }}" class="aiz-side-nav-link">
        <i class="las la-headset aiz-side-nav-icon"></i>
        <span class="aiz-side-nav-text">{{ translate('Chat with Admin') }}</span>
    </a>
</li>
