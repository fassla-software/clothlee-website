<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex align-items-center">
        <a class="btn btn-light d-flex align-items-center px-3 py-2" href="{{ route('home') }}" target="_blank" title="{{ translate('Browse Website') }}">
            <i class="las la-home fs-18 mr-2"></i>
            <span class="fw-600">{{ translate('Home') }}</span>
        </a>
    </div>
</div>
