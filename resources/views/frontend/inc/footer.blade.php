<style>
/* Make the main footer section tighter */
.footer-widget {
...
.footer-widget img.h-150px {
    height: 1300px !important;
    max-height: 130px !important;
    object-fit: contain;
}

/* Reduce margin around the logo */
.footer-widget .mt-3.mb-4 {
    margin-top: 10px !important;
    margin-bottom: 10px !important;
}

/* Tighten about us text spacing */
...
/* Tighten newsletter input section */
.footer-widget form .row {
    margin-top: 10px !important;
}

/* Social icons spacing smaller */
...
<div class="border-top" id="section_last_viewed_products" style="display: none;">
    @php
...
<div class="mt-3 mb-4">
    <a href="{{ route('home') }}" class="d-block">
        @if(get_setting('footer_logo') != null)
            <img class="lazyload h-150px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" 
                 data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" 
                 alt="{{ env('APP_NAME') }}" height="150">
        @else
            <img class="lazyload h-150px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" 
...
@endphp
<section class="py-lg-3 text-light footer-widget" style="display: none !important;">
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2" style="background-color: rgb(255 255 255 / 90%)!important;">
 ...
 <!-- All Shops -->
<div class="col">
    <a href="{{ url('/sellers') }}" class="text-secondary d-block text-center pb-2 pt-3">
        <span class="d-inline-block position-relative px-2">
            <i class="las la-store la-lg"></i>
        </span>
