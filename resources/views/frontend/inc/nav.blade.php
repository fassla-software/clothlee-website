...
@media (max-width: 768px) {
    .front-header-search {
        margin-top: 40px; /* Moves the search bar down */
    }
}
                ...
                <div class="col-6 text-right d-none d-lg-block">
                    <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                        @if (get_setting('vendor_system_activation') == 1)
                            <!-- Become a Seller -->
                            <li class="list-inline-item mr-0 pl-0 py-2" style="display: none">
...
<div class="position-relative logo-bar-area z-1025">
            <div class="container">
                <div class="d-flex align-items-center">
                 ...
                 <!-- Store Icon (Only for Mobile) -->
<div class="d-lg-none ml-3 text-center">
    <a href="
        ...
        @else
            {{ route('shops.create') }}
        @endif
    " class="p-2 d-block text-reset">
        <div class="d-flex flex-column align-items-center">
            <i class="las la-store la-2x"></i>
            <span class="fs-12 mt-1 text-nowrap">{{ translate('Add Brand') }}</span>
        </div>
    </a>
</div>
                    ...
                    <!-- Header Logo -->
<div class="col-auto pl-0 pr-3 d-flex align-items-center text-center text-lg-left">
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @if ($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-130px h-md-40px" height="110">
                            @else
...
@media (max-width: 768px) {  /* Mobile-Only Adjustments */
    ...
    /* Increase header height for big logo */
    header {
        height: 100px !important; /* Taller header for the massive logo */
        display: flex;
        align-items: center;
    }

    /* SUPER BIG LOGO */
    header .logo-bar-area a img {
        height: 150px !important;
        max-height: 150px;
        width: auto;
      margin-left: 0px; /* Adjust left alignment if needed */
            margin-right: 0px; /* Adjust left alignment if needed */

    }

    /* Adjust category menu height */
    #category-menu-bar {
    ...
    /* Adjust cart, menu items, and icons */
    .nav-cart-box,
    .nav-user-info {
...
<div class="d-lg-none search-toggle-mobile text-center">
    <a class="p-2 d-block text-reset" href="javascript:void(0);" data-toggle="class-toggle"
        data-target=".front-header-search">
        <div class="d-flex flex-column align-items-center">
            <i class="las la-search la-flip-horizontal la-2x"></i>
            <span class="fs-12 mt-1 text-nowrap">{{ translate('Search') }}</span>
        </div>
    </a>
</div>
                  ...
                  <!-- Store Icon (Only for Desktop & Tablets) -->
...
@media (max-width: 768px) { 
    /* Ensure logo is centered for both LTR and RTL */
    .logo-bar-area {
    ...
    /* Logo settings for both directions */
    .logo-bar-area a img {
    ...
    /* LTR (English) Specific: Add margin-left: 40px */
    html[dir="ltr"] .logo-bar-area a img {
        margin-left: 40px !important; 
        margin-right: 0 !important;
    }

    /* RTL (Arabic) Specific: Keep it centered */
    html[dir="rtl"] .logo-bar-area a img {
  ...
  /* Ensure all elements respect LTR alignment */
html[dir="ltr"] {
    text-align: left !important;
}

/* Fix header buttons in English layout */
html[dir="ltr"] .top-navbar ul {
    padding-left: 15px !important;
    padding-right: 0 !important;
}

/* Fix search bar spacing */
html[dir="ltr"] .front-header-search {
    text-align: left !important;
...
/* Ensure currency and language switchers are properly aligned */
html[dir="ltr"] #lang-change,
html[dir="ltr"] #currency-change {
    text-align: left !important;
    padding-left: 10px !important;
}

  @media (max-width: 768px) {
    html[dir="rtl"] .search-toggle-mobile {
        margin-left: 40px !important;
        margin-right: -10px !important; /* Adjust as needed */
    }

    html[dir="ltr"] .search-toggle-mobile {
