<div class="text-left">
    <!-- Product Name -->
    <h2 class="mb-4 fs-16 fw-700 text-dark" style="display: none;">
    ...
    <div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-4">
            ...
            @else
                <p class="mb-0 fs-14 fw-700">{{ translate('Clothlee') }}</p>
            @endif
        </div>
        ...
        @if (get_setting('conversation_system') == 1)
            <div class="">
                @auth
              <a href="{{ route('open_chat_with_seller', $detailedProduct->id) }}"
 ...
 <span class="fw-600">{{ translate('Chat with Brand') }}</span>
</a>
              @endauth
    ...
    <button type="button"
        ...
        <span class="fw-600">{{ translate('Login to Chat') }}</span>
    </button>
@endguest
...
<div class="row no-gutters mb-3 mt-3">
  <div class="col-sm-2">
      <div class="text-secondary fs-14 fw-400">Fabric</div>
  </div>
  <div class="col-sm-10">
    <div class="d-flex align-items-center">
      <!-- Discount Price -->
      <strong class="fs-16 fw-700 text-primary">
        {{ $detailedProduct->fabric }}
      </strong>
      <!-- Unit -->
    </div>
  </div>
