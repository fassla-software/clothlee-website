...
@section('content')
    <style>
      .fw-400.fs-13.text-truncate-2.lh-1-4.mb-0.h-35px.text-center {
...
<div class="bg-white px-sm-3">
    <div class="aiz-carousel sm-gutters-17" data-items="8" data-xxl-items="8" data-xl-items="8"
        data-lg-items="6" data-md-items="5" data-sm-items="3" data-xs-items="3" data-arrows="false"
        ...
        @foreach ($featured_categories as $key => $category)
            ...
            <div class="carousel-box px-4 d-flex flex-column align-items-center">
                ...
                <div class="size-80px overflow-hidden hov-scale-img rounded-circle border border-light shadow-sm">
                    <a class="d-block" href="{{ route('products.category', $category->slug) }}">
                        <img src="{{ isset($category->bannerImage->file_name) ? my_asset($category->bannerImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                            class="lazyload img-fit h-100 w-100 mx-auto has-transition rounded-circle"
                            alt="{{ $category->getTranslation('name') }}"
                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                    </a>
                </div>
                <!-- Category Name -->
                <div class="text-center h-35px text-truncate-2 mt-3">
    ...
    <div class="container">
        <div class="row gutters-16">
            ...
            <div class="col-xl-{{ $col_val }} mb-2 mb-md-3 mt-2 mt-md-3" style="display: none">
                <!-- New Products -->
...
@if (count($featured_categories) > 0)
  <section class="mb-3 mb-md-4 pt-3 pt-md-2rem full-width">
    <div class="container-fluid">
            ...
            @foreach ($featured_categories as $category)
                ...
                @if ($category_products->count() > 0)
                    <div class="hot-deals-box category-box rounded bg-white"
                         style="width: 100%; max-width: 1370px; margin: auto;">
                        
                        <!-- Category Header -->
                        <div class="d-flex align-items-center justify-content-between pb-2">
                            <h4 class="fs-16 fw-700 mb-0">{{ $category_name }}</h4>
                            <a href="{{ route('products.category', $category->slug) }}" 
                               class="text-primary fs-14 fw-600">
                                {{ translate('View All') }}
                            </a>
                        </div>

                        <!-- Product Grid (Ensuring Horizontal Layout) -->
    ...
    <a href="{{ route('product',['category_slug'=>$category->slug,'sub_category_slug'=>$product->main_category->slug,'slug'=> $product->slug]) }}" class="d-block text-reset h-100 w-100">
        ...
        <span class="d-block fw-700 text-primary mt-1">
            {{ home_discounted_base_price($product) }}
                        ...
                        <!-- Styles for Proper Mobile & PC Layout -->
                        <style>
                            /* PC Styles */
                            @media (min-width: 992px) {
                                /* Match category sections to Hot Deals */
                                .category-box {
                                ...
                                /* Product Slider (Ensuring Horizontal Layout) */
                                .product-slider {
                                ...
                                /* Product Items should be in rows like Hot Deals */
                                .product-item {
        width: 220px !important;  /* Make products equal width */
        height: 280px !important; /* Make them equal height */
    ...
    /* Image Wrapper (Ensures Consistency) */
    .product-img {
        ...
        align-items: center !important;
        justify-content: center !important;
        overflow: hidden !important; /* Ensures images stay inside */
    }
    ...
    .product-slider {
        gap: 20px !important; /* Add space between products */
    }
    ...
    .product-item .fw-700 {
        font-size: 18px !important;
                              ...
                              /* Ensure full-width scrolling on both PC and Mobile */
.product-slider {
    display: flex !important;
    overflow-x: auto !important;
    scroll-snap-type: x mandatory !important;
    -webkit-overflow-scrolling: touch !important;
    white-space: nowrap !important; /* Ensures products stay in one row */
    width: 100% !important;
    max-width: 100vw !important;
    padding-bottom: 5px !important;
}

/* Make product items scrollable and inline */
.slider-track {
    display: flex !important;
    flex-direction: row !important;
    width: max-content !important;
    min-width: 100% !important;
    gap: 8px !important; /* Keep slight gap */
    justify-content: flex-start !important;
}

/* Match product display between PC & Mobile */
.product-item {
    display: flex !important;
    flex-direction: column !important;
    align-items: center !important;
    ...
    margin: 10px !important; /* Add spacing between product boxes */
}

/* Ensure Images Stay Inside the Box */
.product-item img {
    max-width: 100% !important;
    max-height: 120px !important; /* Prevents images from overflowing */
    object-fit: contain !important;
}

/* Adjust Subcategory & Price Spacing */
.product-item .fs-14 {
...
.product-slider::-webkit-scrollbar {
    display: none;
                            ...
                            /* Mobile: Fix Vertical Stacking & Keep Horizontal */
...
.product-item .fw-700 {
    ...
    .product-item img {
        width: 90px !important; /* Adjust image size */
    ...
    .product-slider::-webkit-scrollbar {
        display: none;
                          ...
                          /* Make the entire section full width */
.full-width {
...
/* Adjust product category box to fit full width */
.category-box {
    width: 100% !important;
    max-width: 100% !important;
    padding: 20px !important;
        ...
        <section class="">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Top Sellers -->
                    <div class="col mb-2 mb-md-3 mt-2 mt-md-3" style="display: none">
