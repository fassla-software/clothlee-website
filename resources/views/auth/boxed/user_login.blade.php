...
@section('content')
    ...
    <img src="https://www.clothlee.com/public/uploads/all/JTNLMogpONWocmgq3kmEONfAbphjNPf5amXD16k0.png" 
         ...
         style="max-height: 150px; width: auto; margin-top: 20px;">
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default" role="form" action="{{ route('userLogin') }}" method="POST">
                                            @csrf
                                            ...
                                            {{--                                            @if (addon_is_activated('otp_system'))--}}
                                                <div class="form-group phone-form-group mb-1">
                                                    ...
                                                    <input type="text" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }} rounded-0" value="{{ old('phone') }}" placeholder="{{  translate('phone') }}" name="phone" autocomplete="off">
                                                </div>
