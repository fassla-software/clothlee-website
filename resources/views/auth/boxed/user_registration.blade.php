...
@section('content')
    ...
    <img src="https://www.clothlee.com/public/uploads/all/JTNLMogpONWocmgq3kmEONfAbphjNPf5amXD16k0.png" 
         ...
         style="max-height: 80px; width: auto; margin-top: 30px;">
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form id="reg-form" class="form-default" role="form" action="{{ route('userRegister') }}" method="POST">
                                            @csrf
                                            <!-- Name -->
                                            ...
                                            {{--                                            @if (addon_is_activated('otp_system'))--}}
                                                <div class="form-group phone-form-group mb-1">
                                                    ...
                                                    <input type="text" id="phone-code" class="form-control rounded-0{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('Phone') }}" name="phone" autocomplete="off">
                                                </div>
