    ...
    <img src="https://www.clothlee.com/public/uploads/all/JTNLMogpONWocmgq3kmEONfAbphjNPf5amXD16k0.png" 
         ...
         style="max-height: 80px; width: auto; margin-top: 30px;">
                                ...
                                <div class="text-center text-lg-left">
                                    ...
                                    <h5 class="fs-14 fw-400 text-dark">{{ translate('Login To Your Brand Account')}}</h5>
                                </div>
                                <!-- Login form -->
                                <div class="pt-3">
...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }} rounded-0" value="{{ old('phone') }}" placeholder="{{  translate('phone') }}" name="phone" id="phone" autocomplete="off">
                                                @if ($errors->has('phone'))
                                                    <span class="invalid-feedback" role="alert">
