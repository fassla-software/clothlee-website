        ...
        return [
            'data' => $this->collection->map(function ($data) {
                ...
                return [
                	...
                	'category_name' => optional($data->categories->first())->getTranslation('name'),
					'subcategory_name' => optional($data->categories->first()?->childrenCategories->first())->getTranslation('name'),
                    ...
                    'shop_name' => $data->added_by == 'admin' ? translate('Clothlee') : $data->user->shop->name,
