...
class NotificationTypeController_seller extends Controller
{
...
return view('seller.notification.notification_types.index', compact('notificationTypes', 'notification_type_sort_search', 'notificationUserType'));
...
return view('seller.notification.notification_types.edit', compact('notificationType','lang'));
    }
