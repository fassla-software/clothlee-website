                ...
                if (!empty($shop_items_raw_data)) {
                    foreach ($shop_items_raw_data as $shop_items_raw_data_item) {
                        ...
                        $shop_items_data_item["product_is_digital"] = $product->digital == 1;
                      	$shop_items_data_item["category_name"] = optional($product->categories->first())->getTranslation('name');
                        $shop_items_data_item["subcategory_name"] = optional($product->categories->first()?->childrenCategories->first())->getTranslation('name');
                        $shop_items_data_item["main_price"] =  home_discounted_base_price($product);
