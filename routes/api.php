...
use App\Http\Controllers\Api\V2\Store\StoreCategoryController;
use App\Http\Controllers\Api\V2\Attribute\AttributeController;
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
  	...
  	Route::controller(StoreCategoryController::class)->group(function () {
        ...
        Route::get('store/category/{slug}', 'storeCategory');
      	// get subcategories
      	Route::get('{store_slug}/{category_slug}/sub-category', 'storeSubCategory');
        // get products of subcategories
      	Route::get('{store_slug}/{category_slug}/{sub_category_slug}/products', 'SubCategoryProduct');
        
    });
  
  	Route::controller(AttributeController::class)->group(function () {
        Route::get('/attribute/{slug}', 'index');
    });
