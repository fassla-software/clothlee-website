...
Route::prefix('user')->middleware(['auth', 'user'])->group(function () {
    Route::get('conversations/admin', [UserConversationController::class, 'adminChat'])->name('user.conversations.admin');
    Route::post('conversations/message/store', [UserConversationController::class, 'message_store'])->name('user.conversations.message_store');
    Route::post('conversations/refresh', [UserConversationController::class, 'refresh'])->name('user.conversations.refresh');
});

Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    Route::get('send-message-notification', [MessageNotificationController::class, 'create'])->name('message_notification.create');
    Route::post('send-message-notification', [MessageNotificationController::class, 'send'])->name('message_notification.send');

});


Route::prefix('seller')->group(function () {
    Route::get('send-message-notification', [MessageNotificationController_seller::class, 'create'])->name('seller.message_notification.create');
    Route::post('send-message-notification', [MessageNotificationController_seller::class, 'send'])->name('seller.message_notification.send');

});

Route::prefix('seller')->middleware(['auth', 'seller'])->group(function () {
    Route::get('conversations/admin', [SellerConversationController::class, 'adminChat'])->name('seller.conversations.admin');
});
...
Route::get('/open-chat/{product_id}', [ConversationController::class, 'openConversationWithSeller'])->name('open_chat_with_seller');

Route::get('/test-fcm', function () {
    $token = 'd63SXMbcSrGMhc5_0BEtfK:APA91bFB0YgrYdB7Bo8BgBcRi1rtUXaW2YIKmcxJ1u7G1DVqtEcbdmhbycnUlHjiTqts0RC6P5tuu9u7f0qrcfF4Pa1-USfkoPafa0TlV18sp6afmVpZLiw';
    ...
    $fields = [
        'message' => [
            ...
            'notification' => [
                'title' => 'Test Push 🔥',
                'body' => 'This is a manual test from Laravel controller',
            ],
            'data' => [
