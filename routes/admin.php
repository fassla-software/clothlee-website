...
Route::get('admin/login', [LoginController::class, 'adminLoginView'])->name('adminLoginView');
Route::post('admin/login', [LoginController::class, 'adminLogin'])->name('adminLogin');

// add seller
Route::get('/sellers/admin-create', [SellerController::class, 'adminCreate'])->name('sellers.adminCreate');
Route::post('/sellers/admin-store', [SellerController::class, 'adminStore'])->name('sellers.adminStore');
